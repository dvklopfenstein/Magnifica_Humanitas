...
<!-- ---------------------------------------------------------------------------- -->
# Credits and License
### The [Magnifica Humanitas](https://www.vatican.va/content/leo-xiv/en/encyclicals/documents/20260515-magnifica-humanitas.html) is copyrighted by the Vatican:

Copyright © Dicastery for Communication - Libreria Editrice Vaticana

### The notes, meta-data, and flashcard material contained herein is copyrighted by:
